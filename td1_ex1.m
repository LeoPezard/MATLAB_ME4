clc % = clear command = efface ce qu'il y a dans command window en bas
l = [1 2 3 4 5];
l2 = 1:5; %meme chose que ligne du dessus
l3 = l'; %transposée de l
fprintf("Vecteur l");
l
fprintf("Transposée de l");
l3
...
C = A*B;
C
fprintf("Produit des éléments de A et B:");
C2 = A.*B;
C2
